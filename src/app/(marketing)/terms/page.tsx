...
export default function TermsOfServicePage() {
  return (
    <LegalPageLayout title='Terms of Service'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to EMB Web Designs, 1253 Bishops Rd, Los
        ...
        <li>
          <p>
            <strong>Website</strong> refers to EMB Web Designs, accessible from{" "}
            <a
              href='https://embwebdesigns.com/'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://embwebdesigns.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: contact@embwebdesigns.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href='https://embwebdesigns.com/contact'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://embwebdesigns.com/contact
            </a>
          </p>
        </li>
      </ul>
